...
%\author{Your Name}
\author{Name1 \inst{1} \and Name2 \inst{2} \and Name3 \inst{2}}
...
Poster Session \hfill
  \href{mailto:youremail@msu.edu}{youremail@iastate.edu}}
...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \node [anchor=north west, inner sep=3cm] at ([xshift=0.0cm,yshift=-2.5cm]current page.north west){\huge \textbf{Department Name}}; % Department name
